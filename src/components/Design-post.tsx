        ...
        <Grid.Container gap={2} justify="center">
            <Card isPressable isHoverable variant="bordered" css={{ mw: '400px' }}>
                ...
                <Card.Body css={{ py: '$10' }}>
                    ...
                    <Spacer y={1} />
                    <Text>
                        Ingrediente: 350 faina 3 oua 50 g unt topit 500 ml lapte rece 250 ml apa minerala un praf de
                        sare optional: vanilie, coaja de lamaie ulei pentru prajit
                    </Text>
                    <Text>Mod de preparare:</Text>
                </Card.Body>
                <Card.Divider />
                <Card.Footer>
