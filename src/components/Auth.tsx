...
import { changePhotoURL, createUserCollection, createFollowCollection } from '../database/firestore-db';
...
function Auth() {
    ...
    const handleRegister = async () => {
        try {
            ...
            changePhotoURL('https://haikyuu.store/wp-content/uploads/2021/09/Kei-Tsukishima-Merch.png', result.user);
